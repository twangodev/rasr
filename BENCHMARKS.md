...
| `whisper:openai/whisper-large-v3` | generic | 0.379 | 0.234 | 0.346 | 0.364 | 2 |
...
rasr eval run -m whisper:openai/whisper-large-v3                       -d hf:jlvdoorn/atco2-asr:validation --language en --batch-size 16
